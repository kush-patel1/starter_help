...
function App() {
  ...
  const [detailedAnswers, setDetailedAnswers] = useState(Array(7).fill(''));
  const [basicAnswers, setBasicAnswers] = useState(Array(7).fill(''));
 ...
 function homeClick(){
  ...
  if (pageVal === 0 && !ifLogged){
    ...
    return <Results basicAnswers = {basicAnswers} detailedAnswers = {detailedAnswers} apiKey={keyData}></Results>
  }
}
